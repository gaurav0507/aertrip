...
class Format {
    ...
    public function to_json($data = NULL)
    {
        ...
        {
            return json_encode($data,$this->_CI->config->item('json_encode_format_constant'));
        }
        ...
        elseif (preg_match('/^[a-z_\$][a-z0-9\$_]*(\.[a-z_\$][a-z0-9\$_]*)*$/i', $callback))
        {
            ...
            return $callback.'('.json_encode($data,$this->_CI->config->item('json_encode_format_constant')).');';
        }
